...
export default function StatsBar() {
  ...
  const stats = [
    { label: 'Upcoming',   value: upcoming,   unit: 'events' },
    { label: 'Countries',  value: countries,  unit: 'regions' },
    { label: 'Online',     value: online,     unit: 'virtual' },
    { label: 'Organizers', value: organizers, unit: 'hosts' },
  ];
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
      {stats.map(({ label, value, unit }) => (
        <div
          key={label}
          className="bg-white rounded-2xl px-5 py-4 card-shadow"
        >
